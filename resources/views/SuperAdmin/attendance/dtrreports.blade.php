        ...
        <tr>
            <td>
                <header class="header">
                    ...
                    <p>-----o0o-----</p>
                    <p style="font-size: 14px; margin-bottom: 10px;"><u><b>{{ Auth::user()->lastname }},
                                {{ Auth::user()->name }}</b></u></p>
                    ...
                    <p style="text-align: start; margin-bottom: 2px;">Arrival and Departure Saturday
